                        ...
                        <div class="tab-pane active" id="one_read">
                            <div class="row">
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        <div class="product-thubnail">
                                            <img src="/theme/images/product/product1.jpg" alt="product 1" />
                                ...
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        <div class="product-thubnail">
                                            <img src="/theme/images/product/product2.jpg" alt="product 2" />
                                            <div class="product-meta">
                                                <a class="add-to-cart" href="shop-cart.html">Add to cart</a>
                                                <span class="quick-view">
                                                    <a href="#">Quick view</a>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        <div class="product-thubnail">
                                            <img src="/theme/images/product/product3.jpg" alt="product 3" />
                                            <div class="product-meta">
                                                <a class="add-to-cart" href="shop-cart.html">Add to cart</a>
                                                <span class="quick-view">
                                                    <a href="#">Quick view</a>
                        ...
                        <div class="tab-pane" id="x_road">
                            <div class="row">
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        <div class="product-thubnail">
                                            <img src="/theme/images/product/product2.jpg" alt="product 1" />
                                            <div class="product-meta">
                                                <a class="add-to-cart" href="shop-cart.html">Add to cart</a>
                                                <span class="quick-view">
                                                    <a href="#">Quick view</a>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        <div class="product-thubnail">
                                            <img src="/theme/images/product/product1.jpg" alt="product 2" />
                                            <div class="product-meta">
                                                <a class="add-to-cart" href="shop-cart.html">Add to cart</a>
                                                <span class="quick-view">
                                                    <a href="#">Quick view</a>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="event-thumbail">
                                <img src="/theme/images/product/single-product.jpg" alt="product event">
                            </div>
                        </div>
                        <div class="col-md-6">
        ...
        <div class="section-large-top">
            <div class="container">
                ...
                <div class="tz-shortcode-tabs">
                    ...
                    <!--Tabs Header-->
                    <div class="tz-tabs-header">
                        <h2 class="tz-tabs-title pull-left">Latest Products</h2>
                        <?php /*?>
                        <ul class="nav nav-tabs pull-right tz-nav-tabs">
