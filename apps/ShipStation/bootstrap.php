<?php
class ShipStationBootstrap extends \Dsc\Bootstrap
{
    protected $dir = __DIR__;
    protected $base = __DIR__;
    protected $namespace = 'ShipStation';
    ...
    protected function runAdmin()
    {
        ...
        \Modules\Factory::registerPath( \Base::instance()->get('PATH_ROOT') . "apps/ShipStation/Modules/" );
